...
class EditHeader extends React.Component {
  ...
  render() {
    return (
      <div className={"EditHeader" + (this.props.canEdit ? " canEdit" : "")}>
        <HoverDropdown toggleContent={<div>ADD TILE</div>} className="EditHeaderDropdown">
          <HoverDropdown.Item onClick={() => this.props.addTile("ToDoListTile")}>Todo List</HoverDropdown.Item>
          <HoverDropdown.Item onClick={() => this.props.addTile("BookmarksTile", { width: 2 })}>Bookmarks</HoverDropdown.Item>
          ...
          <HoverDropdown.Item onClick={() => this.props.addTile("RandomImageTile")}>Cat Gifs</HoverDropdown.Item>
          <HoverDropdown.Item onClick={() => this.props.addTile("NotesTile")}>Note</HoverDropdown.Item>
          <HoverDropdown.Item onClick={() => this.props.addTile("TwitchTile")}>Twitch</HoverDropdown.Item>
        ...
        <HoverDropdown toggleContent={<div>BACKGROUND</div>} className="EditHeaderDropdown">
          <div className="BackgroundPicker">
            ...
            <button onClick={() => { document.getElementById("inputBackgroundImageURL").value = ""; this.updateBackground("") }}>Remove Image</button>
          </div>
        </HoverDropdown>
